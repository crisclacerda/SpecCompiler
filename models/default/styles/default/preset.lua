...
return {
    ...
    paragraph_styles = {
        ...
        },
        {
            ...
            based_on = "Normal",
            next = "FirstParagraph",
            font = { name = "Calibri Light", size = 18, bold = true, color = "212121" },
        ...
        },
        {
            ...
            based_on = "Normal",
            next = "FirstParagraph",
            font = { name = "Calibri Light", size = 14, bold = true, color = "212121" },
        ...
        },
        {
            ...
            based_on = "Normal",
            next = "FirstParagraph",
            font = { name = "Calibri", size = 12, bold = true, color = "212121" },
            spacing = { before = 2, after = 0, line = 1.15 },
            indent = { first_line = "0in" },
            keep_next = true,
            outline_level = 2,
        },
        {
            ...
            based_on = "Normal",
            next = "FirstParagraph",
            font = { name = "Calibri", size = 12, italic = true, color = "212121" },
            spacing = { before = 2, after = 0, line = 1.15 },
            indent = { first_line = "0in" },
            keep_next = true,
            outline_level = 3,
        },
        {
            ...
            based_on = "Normal",
            next = "FirstParagraph",
            font = { name = "Calibri", size = 12, color = "212121" },
            spacing = { before = 2, after = 0, line = 1.15 },
            indent = { first_line = "0in" },
            keep_next = true,
            outline_level = 4,
        },
        {
            ...
            based_on = "Normal",
            next = "FirstParagraph",
            font = { name = "Calibri Light", size = 28, color = "212121" },
        ...
        -- Cover page styles
        {
            ...
            name = "Cover Title",
            based_on = "Normal",
            font = { name = "Calibri", size = 28, bold = true, color = "212121" },
